...
const ProductsPage: React.FC = () => {
  ...
  // Separate applied price filters (only used when Apply button is clicked)
  ...
  const handleBadgeFilter = (
    type: 'new' | 'sale' | 'highrated' | 'freeshipping'
  ) => {
    switch (type) {
      case 'new':
  ...
  const transformedProducts: Product[] = useMemo(() => {
    ...
    return productsData.products.map(transformDatabaseProduct);
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Discover our exclusive collection of luxury items from the world's
            finest brands
          </p>
        </div>
        ...
        {!loading && !error && productsData && (
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            <p className="text-gray-600">
              ...
              {selectedBrand !== 'all' &&
                ` from ${productsData.brands.find(b => b.id === selectedBrand)?.name}`}
            </p>
        ...
        {!loading &&
          ...
          productsData.pagination.totalPages > 1 && (
            <ProductsPagination
              ...
              hasPrevious={productsData.pagination.hasPrevious}
