        ...
        <PaginationContent>
          ...
          <PaginationItem>
            <PaginationPrevious 
              ...
              className={!hasPrevious ? 'pointer-events-none opacity-50' : 'cursor-pointer hover:bg-gray-100'}
            />
          </PaginationItem>
          ...
          <PaginationItem>
            <PaginationNext
              ...
              className={!hasNext ? 'pointer-events-none opacity-50' : 'cursor-pointer hover:bg-gray-100'}
            />
          </PaginationItem>
        </PaginationContent>
      </Pagination>
