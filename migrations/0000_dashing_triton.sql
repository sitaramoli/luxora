CREATE TYPE "public"."account_status" AS ENUM('ACTIVE', 'PENDING', 'SUSPENDED');--> statement-breakpoint
...
ALTER TABLE "order_items" ADD CONSTRAINT "order_items_merchant_id_merchants_id_fk" FOREIGN KEY ("merchant_id") REFERENCES "public"."merchants"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
